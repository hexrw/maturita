...
Běžný hardware, který můžete najít připojený k vnější straně počítače, ačkoli mnoho tabletů, notebooků a netbooků integruje některé z těchto položek do svých krytů:
